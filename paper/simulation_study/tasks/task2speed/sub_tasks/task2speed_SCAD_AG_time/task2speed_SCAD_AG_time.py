...
print("This script gets the running time for accelerated gradient running on SCAD-penalized logistic models.")
...
SCAD_sim_results_AG_time = cp.zeros((3, 4, 100, 1))

for i, j, seed in itertools.product(range(3), range(4), range(100)):
    SCAD_sim_results_AG_time[i, j, seed, :] = simulator_compute_time_AG(
        seed=seed,
        SNR=5.,
...
cp.save("SCAD_sim_results_AG_time", SCAD_sim_results_AG_time)
