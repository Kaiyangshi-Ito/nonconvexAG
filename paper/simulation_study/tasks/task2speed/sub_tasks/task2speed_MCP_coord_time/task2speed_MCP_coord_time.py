...
print("This script gets the running time for coordinate descent running on MCP-penalized logistic models.")
...
MCP_sim_results_coord_time = cp.zeros((3, 4, 100, 1))

for i, j, seed in itertools.product(range(3), range(4), range(100)):
    MCP_sim_results_coord_time[i, j, seed, :] = simulator_compute_time_coord(
        seed=seed,
        SNR=5.,
...
cp.save("MCP_sim_results_coord_time", MCP_sim_results_coord_time)
