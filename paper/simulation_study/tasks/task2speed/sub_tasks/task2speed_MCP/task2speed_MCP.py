...
print("This script gets the gradient evaluation times for AG and proximal gradient running on MCP-penalized logistic models.")
...
MCP_sim_results = cp.zeros((3, 4, 100, 3))
